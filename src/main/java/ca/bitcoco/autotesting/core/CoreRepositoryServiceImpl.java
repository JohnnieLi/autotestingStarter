 ...
 *
 * if using JPA,Hibernate with SQL database,  use <Rep  extends JpaRepository<T, ID>, T, ID>
 * if using NO-SQL database, such as mongodb, use <Rep  extends MongoRepository<T, ID>, T, ID>
 * @author Jiangqi Li
 */
public class CoreRepositoryServiceImpl<Rep  extends JpaRepository<T, ID>, T, ID> implements CoreRepositoryService<T, ID> {
