package ca.bitcoco.autotesting.user.web;

import ca.bitcoco.autotesting.core.CoreResponseBody;
import ca.bitcoco.autotesting.core.security.SecurityUtils;
import ca.bitcoco.autotesting.user.User;
import ca.bitcoco.autotesting.user.UserServiceImpl;
...
import static ca.bitcoco.autotesting.core.security.SecurityUtils.HEADER_STRING;
import static ca.bitcoco.autotesting.core.security.SecurityUtils.TOKEN_PREFIX;
